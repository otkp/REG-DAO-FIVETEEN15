 ...
 */
@Component
public class CfstSyncRegstrationMapper extends BaseMapper<RegistrationDetailsDTO, CfstSyncRegstrationVO> {
	...
	@Autowired
	private CfstFinanceDetailsMapper financeDetailsMapper;
	...
	@Autowired
	private CfstRegistrationValidityMapper registrationValidityMapper;

	@Override
	public CfstSyncRegstrationVO convertEntity(RegistrationDetailsDTO dto) {

		CfstSyncRegstrationVO registrationDetailsVO = new CfstSyncRegstrationVO();
