...
public class MasterVillageDTO extends BaseEntity implements Serializable {
	...
	public String toString() {
		return "MasterVillageDTO [id=" + id + ", mandalId=" + mandalId + ", status=" + status + ", villageCode="
				+ villageCode + ", villageId=" + villageId + ", villageName=" + villageName + "]";
	}
