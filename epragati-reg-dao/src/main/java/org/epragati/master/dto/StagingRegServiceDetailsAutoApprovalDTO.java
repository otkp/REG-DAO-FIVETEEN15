...
@Document(collection = "staging_reg_services_auto_approval_logs")
public class StagingRegServiceDetailsAutoApprovalDTO extends BaseEntity implements Serializable{
