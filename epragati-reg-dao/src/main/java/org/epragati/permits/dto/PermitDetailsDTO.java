 ...
 *
 */
@Document(collection = "permit_details")
public class PermitDetailsDTO extends BaseEntity implements Serializable, Cloneable {
	...
	/**
	 * @param isPermitSurrenderWithCOA the isPermitSurrenderWithCOA to set
	 */
	...
	/**
	 * @param isPermitSurrenderWithTOW the isPermitSurrenderWithTOW to set
	 */
	...
	/**
	 * @param permitValidityDetails the permitValidityDetails to set
	 */
	...
	/**
	 * @param sTCTvehcleDetailsDTO the sTCTvehcleDetailsDTO to set
	 */
	...
	/**
	 * @param recomendationLetterNo the recomendationLetterNo to set
	 */
	...
	/**
	 * @return the replacedToPrNo
	 */
	public String getReplacedToPrNo() {
		return replacedToPrNo;
	}

	/**
	 * @param replacedToPrNo the replacedToPrNo to set
	 */
	public void setReplacedToPrNo(String replacedToPrNo) {
		this.replacedToPrNo = replacedToPrNo;
	}

	public Boolean getIsRcCancelled() {
		return isRcCancelled;
	}

	public void setIsRcCancelled(Boolean isRcCancelled) {
	...
	public String getRcCancelledBy() {
		return rcCancelledBy;
	}

	public void setRcCancelledBy(String rcCancelledBy) {
		this.rcCancelledBy = rcCancelledBy;
	}
