...
@Document(collection = "SAS_payments")
@CompoundIndexes({ @CompoundIndex(name = "moduleCode", def = "{'payStatus': 1}") })
public class PaymentTransaction_last5d extends BaseEntity implements Serializable {
	...
	/**
	 * @param sbiTransactionNumber
	 *            the sbiTransactionNumber to set
	 */
	...
	/**
	 * @param breakPaymentsSave
	 *            the breakPaymentsSave to set
	 */
	public void setBreakPaymentsSave(BreakPaymentsSaveDTO breakPaymentsSave) {
		BreakPaymentsSave = breakPaymentsSave;
	}
	...
	/**
	 * @param applicationFormRefNum
	 *            the applicationFormRefNum to set
	 */
	...
	/**
	 * @param payURefundResponse
	 *            the payURefundResponse to set
	 */
	...
	/**
	 * @param payURefundResponseLog
	 *            the payURefundResponseLog to set
	 */
	 ...
	 *            the paymentTransactionNo to set
	 */
